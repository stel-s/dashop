...
<?php
	...
	$short_by = !empty ($pagination) ? 'col-md-7 col-sm-12 col-xs-12' : 'col-md-10 col-xs-12';
	$devices = array(
		'md' => ' Desktops',
		'sm' => ' Tablets',
		'xs' => ' Phones',
...
<div class="container">
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
			...
			<div class="product-filter filters-panel">
			  <div class="row">
				...
				<?php if (!empty($pagination)){?>
					<div class="box-pagination col-md-3 col-xs-12 text-right"><?php echo $pagination; ?></div>
				<?php }?>
			  </div>
			</div>
			<!-- //end Filters -->
        ...
        <div class="product-layout col-lg-3 col-md-4 col-sm-6 col-xs-12 <?php //echo $device_res;?>">
