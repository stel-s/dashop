		...
		if ($product_info) {
         ...
         $data['description'] = $this->shortcodes->do_shortcode($data['description']);
			...
			if ($product_info['image']) {
				$data['popup'] = "http://www.tsago.gr/assets/products/12-106.jpg";
			} else {
				$data['popup'] = '';
			}

			if ($product_info['image']) {
				$data['thumb'] = "http://www.tsago.gr/assets/products/12-106.jpg";
			} else {
				$data['thumb'] = '';
			}
			...
			foreach ($results as $result) {
				$data['images'][] = array(
					'popup' => "http://www.tsago.gr/assets/products/12-106.jpg",
					'thumb' => "http://www.tsago.gr/assets/products/12-106.jpg",
				);
			}
