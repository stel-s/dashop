...
<?php
	...
	if (isset($soconfig_pages["discount_status"])) $discount_status = $soconfig_pages["discount_status"];
    ...
    <div id="content" class="<?php echo $class; ?>">
        <div class="row product-view clearfix">
			<?php //Img Gallery Block -------?>
                <div class="content-product-left  <?php if(isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left'){echo "col-sm-6 col-xs-12"; }else { echo "col-sm-5 col-xs-12"; } ?> ">
			...
			<div class="content-product-right  <?php if(isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left'){echo "col-sm-6 col-xs-12"; }else { echo "col-sm-7 col-xs-12"; } ?>">
				...
				<div class="product-label">
					...
					<div class="product_page_price price" itemprop="offerDetails" itemscope itemtype="http://data-vocabulary.org/Offer">
						...
						<span class="label label-percent"><?php echo $discount; ?></span>
