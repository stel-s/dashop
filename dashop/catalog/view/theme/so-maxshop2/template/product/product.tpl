        ...
        <div class="product-view row">
		  <div class="left-content-product <?php echo (!empty($column_right)  || isset($html_product_right) && $html_product_right != '' && $html_product_right != '<p>&nbsp;</p>' ? 'col-lg-10 col-xs-12' : 'col-xs-12'); ?>">
			...
			<?php //Img Gallery Block -------?>
                ...
                <div class="content-product-left  <?php if(isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left'){echo "col-md-6 col-xs-12"; }else { echo "col-md-6 col-xs-12"; } ?> ">
			...
			<div class="content-product-right <?php if(isset($soconfig_pages["thumbnails_position"]) && $soconfig_pages["thumbnails_position"] == 'left'){echo "col-md-6 col-xs-12"; }else { echo "col-md-6 col-xs-12"; } ?>">
